...
public abstract class Employe {
    ...
    public Employe(String matricule,String nom, String prenom, int age, String date,int salairebase){
...
class Salaires {
    public static void main(String[] args) {
        ...
        p.ajouterEmploye(new Vendeur("15A", "Youssouf","Ali", 45, "1995", 110000,110000));
        p.ajouterEmploye(new Representant("01C","mht", "Aht", 25, "2001", 110000,110000));
        p.ajouterEmploye(new Technicien("02A","Yves", "Boris", 28, "1998", 10,110000));
        p.ajouterEmploye(new Manutentionnaire("50A","Issa", "Yaya", 32, "1998",2.0, 45,110000));
        p.ajouterEmploye(new TechnARisque("04B","Younis", "Alkhali", 28, "2000", 10,110000));
        p.ajouterEmploye(new ManutARisque("01A","Ali", "Bakhit", 30, "2001",2.0, 45,110000));
